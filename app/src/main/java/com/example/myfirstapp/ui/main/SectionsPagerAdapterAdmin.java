...
import com.example.myfirstapp.CseFormResponses;
import com.example.myfirstapp.EntcForm;
import com.example.myfirstapp.EntcFormResponses;
import com.example.myfirstapp.MechForm;
import com.example.myfirstapp.MechFormResponses;
...
public class SectionsPagerAdapterAdmin extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position){
            case 0:
                return new CseFormResponses();

            case 1:

                return new MechFormResponses();
            case 2:

                return new EntcFormResponses();
            default:
